...
"""
SUPPORTED_MODELS = ['mbert', 'xlmr', 'tulrv6', 'both']
...
"""
	writing scripts grouped by languages
"""
arab = ['ba', 'ckb', 'fa', 'ps', 'sd', 'sw', 'ug', 'ur', 'br', 'ku']
armn = ['hy']
beng = ['as', 'bn']
cyrl = ['kk', 'ky', 'bg', 'mk', 'ru', 'tg', 'tt', 'uk', 'sr']
deva = ['pa', 'hi', 'mr', 'ne']
elba = ['sq']
geor = ['ka']
grek = ['el']
...
kore = ['ko']
lao = ['lo']
latn = ['az', 'bs', 'af', 'am', 'ar', 'be', 'ca', 'cs', 'cy', 'da', 'de', 'en', 'es', 'et', 'eu', 'fi', 'fr', 'ga', 'gl', 'hu', 'id', 'is', 'it', 'lt', 'lv', 'ms', 'mt', 'nl', 'no', 'or', 'pl', 'pt', 'ro', 'sk', 'sl', 'sv', 'tr', 'uz', 'vi', 'fy', 'gd', 'ha', 'hr', 'la', 'mg', 'nn', 'om', 'so', 'xh', 'su', 'tl']
mlym = ['ml']
mymr = ['my']
sinh = ['si']
taml = ['ta']
